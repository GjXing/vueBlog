...
const state = {
  ...
  auth: {
    ...
    clientID: '57a7bf0dd56d401043a4',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'c699b686ea6522e7f2bd31620dabd222da50f425'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/GjXing'  // 第三方站点的 url
    }
